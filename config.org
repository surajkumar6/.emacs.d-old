...
#+BEGIN_SRC emacs-lisp
  ...
  (setq org-capture-templates
   '(("c" "Templates for collecting thoughts and ideas")
     ("ca" "Articles/Links" entry (file+headline "~/Dropbox/Org/organizer/collection_bucket.org" "Articles/Links")
        "* [[%^{Link}][%^{Description}]]\n %T" :immediate-finish t)
     ("cb" "Books" entry (file+headline "~/Dropbox/Org/organizer/collection_bucket.org" "Books")
      "* Read %?\n %T")
     ("cc" "College" entry (file+headline "~/Dropbox/Org/organizer/collection_bucket.org" "College")
      "* %?\n %T")
     ("cd" "Dreams" entry (file+headline "~/Dropbox/Org/organizer/collection_bucket.org" "Dreams")
      "* %?\n %T")
     ("cg" "Goals" entry (file+headline "~/Dropbox/Org/organizer/collection_bucket.org" "Goals")
      "* %?\n %T")
     ("ch" "Habits" entry (file+headline "~/Dropbox/Org/organizer/collection_bucket.org" "Habits")
      "* %?\n %T")
     ("ci" "Ideas" entry (file+headline "~/Dropbox/Org/organizer/collection_bucket.org" "Ideas")
      "* %?\n %T")
     ("cl" "Learn" entry (file+headline "~/Dropbox/Org/organizer/collection_bucket.org" "Learn")
      "* %?\n %T")
     ("cm" "Movies" entry (file+headline "~/Dropbox/Org/organizer/collection_bucket.org" "Movies")
      "* Watch %?\n %T")
     ("co" "Others" entry (file+headline "~/Dropbox/Org/organizer/collection_bucket.org" "Others")
      "* %?\n %T")
     ("cp" "Purchase" entry (file+headline "~/Dropbox/Org/organizer/collection_bucket.org" "Purchase")
      "* Buy %?\n %T")
     ("ct" "TV series" entry (file+headline "~/Dropbox/Org/organizer/collection_bucket.org" "TV series")
      "* Watch %?\n %T")
     ("cv" "Videos" entry (file+headline "~/Dropbox/Org/organizer/collection_bucket.org" "Videos")
        "* [[%^{Link}][%^{Description}]]\n %T" :immediate-finish t)
     ("cw" "Work" entry (file+headline "~/Dropbox/Org/organizer/collection_bucket.org" "Work")
      "* %?\n %T")
     ("j" "Journal" entry (file+datetree (concat "~/Dropbox/Org/journal/" (format-time-string "%Y" (current-time)) "/" (format-time-string "%B" (current-time)) ".org"))
      "* %?\nEntered on %U\n  %i\n  %a")
